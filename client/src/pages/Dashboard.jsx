...
// 1. Import your chatbot components
...
function Dashboard() {
  ...
  // 2. Add state for opening/closing the chatbot modal
  ...
  return (
    <div>
      ...
      {/* 3. Render the floating circle button and the full-screen chat modal here */}
